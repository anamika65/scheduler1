...
/*
 * Controller for Downloading the Help Guide
 * @Author : Anamika
 */
...
public class FileDownloadController {
    ...
    */
   private String filePath = "/resources/downloads/UserGuide.pdf";
    ...
    */
   	...
   	// construct the complete absolute path of the file
        String fullPath = sc.getRealPath(filePath) ;
        
        System.out.println("Path Address: " + fullPath);
