				    ...
				    <div id="myAddURL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					        ...
					        <div class="modal-body" style="text-align:left;">
					            ...
					            <tr>
									...
									<td style="vertical-align:baseline;">						              
							            <textarea name="description" type="text" placeholder="Type description..." rows="3"></textarea>
						            </td>
						        </tr>
					            <tr style="height:55px;vertical-align:top;">
						            <td></td>
						            <td>
							            <input name="specialTrunk" type="radio" value="true" checked="checked" style="vertical-align:baseline"/> Special trunk
							            <br>
							            <input name="specialTrunk" type="radio" value="false" style="vertical-align:baseline"> Common trunk
						            </td>
						        </tr>
					            <tr>
					            	<td class="tdCatalogueType1" style="vertical-align:baseline;">
											<label class="control-label" > Number of easy operations: </label>
									</td>
									<td style="vertical-align:baseline;">
						              <div class="control-group">
						              	<div class="controls">
						              		<input name="easy" type="number" min="0" max="150" placeholder="Type nr..." style="width:120px;vertical-align:baseline" required/>
						             	</div>
						              </div>
						            </td>
					            </tr>
					            <tr>
					            	<td class="tdCatalogueType1" style="vertical-align:baseline;">
											<label class="control-label" > Number of normal operations: </label>
									</td>
									<td style="vertical-align:baseline;">
						              <div class="control-group">
						              	<div class="controls">
						              		<input name="normal" type="number" min="0" max="150" placeholder="Type nr..." style="width:120px;vertical-align:baseline" required/>
						             	</div>
						              </div>
						            </td>
					            </tr>
					            <tr>
					            	<td class="tdCatalogueType1" style="vertical-align:baseline;">
											<label class="control-label" > Number of hard operations: </label>
									</td>
									<td style="vertical-align:baseline;">
						              <div class="control-group">
						              	<div class="controls">
						              		<input name="hard" type="number" min="0" max="150" placeholder="Type nr..." style="width:120px;vertical-align:baseline" required/>
						             	</div>
						              </div>
						            </td>
					            </tr>
