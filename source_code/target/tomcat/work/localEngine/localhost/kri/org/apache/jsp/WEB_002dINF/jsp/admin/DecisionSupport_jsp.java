...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("\r\n");
      out.write("<link href=\"../resources/bootstrap/extension/datepicker.css\"\r\n");
      out.write("\trel=\"stylesheet\" />\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\tvar CHECK_SUBMIT = false;\r\n");
      out.write("\t\t$(\"input,select,textarea\").not(\"[type=submit]\")\r\n");
      out.write("\t\t\t\t.jqBootstrapValidation();\r\n");
      out.write("\t\t$(\"#zebraTable tr:nth-child(even)\").addClass(\"zerba\");\r\n");
      out.write("\r\n");
      out.write("\t\t/*Sakib [*/\r\n");
      out.write("\t\t$(\".catalogue1, .catalogue2, .catalogue11, .catalogue22\").hide();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t///////////////////////////////////////////////OPS mapping for adding operation////////////////////////////////////\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Select a Catalogue\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForFirstOpscode\").val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Catalogue found\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t$(\".catalogue1\").show();\r\n");
      out.write("\t\t\t} else\r\n");
      out.write("\t\t\t\t$(\".catalogue1\").hide();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\"#catalogueForFirstOpscode\").change(function() {\r\n");
      out.write("\t\t\tif (parseInt($(\"#catalogueForFirstOpscode\").val()) > 0) {\r\n");
      out.write("\t\t\t\t$(\".mappingSuggestion1\").html(\"Updating Catalogue...\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.css(\"color\", \"#00aa00\");\r\n");
      ...
      out.write("\t\t\t\t\t\t$(\"#catalogueForFirstOpscode\").find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Internal server error\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t//$(\"#catalogueForFirstOpscode\").val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Catalogue updated\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Select a Catalogue\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForSecondOpscode\").val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Catalogue found\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t$(\".catalogue2\").show();\r\n");
      out.write("\t\t\t} else\r\n");
      out.write("\t\t\t$(\".catalogue2\").hide();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\"#catalogueForSecondOpscode\").change(function() {\r\n");
      out.write("\t\t\tif (parseInt($(\"#catalogueForSecondOpscode\").val()) > 0) {\r\n");
      out.write("\t\t\t\t$(\".mappingSuggestion2\").html(\"Updating Catalogue...\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.css(\"color\", \"#00aa00\");\r\n");
      ...
      out.write("\t\t\t\t\t\t$(\"#catalogueForSecondOpscode\").find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Internal server error\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t//$(\"#catalogueForFirstOpscode\").val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Catalogue updated\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t} else {\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t///////////////////////////////////////////////////////////////////////////////////////////////////////////////////\r\n");
      out.write("\t\t///////////////////////////////////////////////OPS mapping for editing operation///////////////////////////////////\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\".editButon\").click(function() {\r\n");
      out.write("\t\t\tvar postId = $(this).attr(\"id\").substring(9);\r\n");
      out.write("\t\t\t$(\".catalogueForFirstOpscodeEdit\").find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t$(\".mappingSuggestion1\").html(\"\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t$(\".catalogueForSecondOpscodeEdit\").find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t$(\".mappingSuggestion2\").html(\"\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t$(\".catalogue11\").hide();\r\n");
      out.write("\t\t\t$(\".catalogue22\").hide();\r\n");
      out.write("\t\t\tif ($.trim($(\"#firstOpscodeEdit\"+postId).val()).length) {\r\n");
      out.write("\t\t\t\t$(\"#firstOpscodeEdit\"+postId).blur();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif ($.trim($(\"#secondOpscodeEdit\"+postId).val()).length) {\r\n");
      out.write("\t\t\t\t$(\"#secondOpscodeEdit\"+postId).blur();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//Empty checking for Ops code mapping\r\n");
      out.write("\t\t$(\".editOperationForm\").submit(function(event) {\r\n");
      out.write("\t\t\tvar postId = $(this).attr(\"id\").substring(17);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif ($.trim($(\"#firstOpscodeEdit\"+postId).val()).length) {\r\n");
      out.write("\t\t\t\tif (parseInt($(\"#catalogueForFirstOpscodeEdit\"+postId).val()) <= 0) {\r\n");
      out.write("\t\t\t\t\talert(\"#firstOpscodeEdit\"+postId);\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif ($.trim($(\"#secondOpscodeEdit\"+postId).val()).length) {\r\n");
      out.write("\t\t\t\tif (parseInt($(\"#catalogueForSecondOpscodeEdit\"+postId).val()) <= 0) {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t//For First OpsCode\r\n");
      out.write("\t\t$(\".firstOpscodeEdit\").blur(function() {\r\n");
      out.write("\t\t\tif ($.trim($(this).val()).length) {\r\n");
      out.write("\t\t\t\tvar postId = $(this).attr(\"id\").substring(16);\r\n");
      out.write("\t\t\t\tvar psValue1 = $.trim($(this).val());\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"../administration/decisionsupport/checkmapping\",//servlet URL that gets first option as parameter and returns JSON of to-be-populated options\r\n");
      out.write("\t\t\t\t\tdata : \"psValue=\"+ psValue1,\r\n");
      out.write("\t\t\t\t\ttype : \"POST\",//request type, can be GET\r\n");
      ...
      out.write("\t\t\t\t\t// -1 : PSCode doesn't exist, 0 : Catalogue not mapped yet, others : Catalogue already mapped\r\n");
      out.write("\t\t\t\t\tif (data == \"-1\" || data == \"0\") {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForFirstOpscodeEdit\"+postId).find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Select a Catalogue\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForFirstOpscodeEdit\"+postId).val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Catalogue found\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t$(\".catalogue11\").show();\r\n");
      out.write("\t\t\t} else\r\n");
      out.write("\t\t\t\t$(\".catalogue11\").hide();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\".catalogueForFirstOpscodeEdit\").change(function() {\r\n");
      out.write("\t\t\tvar postId = $(this).attr(\"id\").substring(28);\r\n");
      out.write("\t\t\tif (parseInt($(this).val()) > 0) {\r\n");
      out.write("\t\t\t\t$(\".mappingSuggestion1\").html(\"Updating Catalogue...\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.css(\"color\", \"#00aa00\");\r\n");
      out.write("\t\t\t\tvar clValue1 = $(this).val();\r\n");
      out.write("\t\t\t\tvar psValue1 = $.trim($(\"#firstOpscodeEdit\"+postId).val());\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"../administration/decisionsupport/updatemapping\",//servlet URL that gets first option as parameter and returns JSON of to-be-populated options\r\n");
      out.write("\t\t\t\t\tdata : \"psValue=\"+ psValue1 + \"&clValue=\" + clValue1,\r\n");
      out.write("\t\t\t\t\ttype : \"POST\",//request type, can be GET\r\n");
      ...
      out.write("\t\t\t\t\t// 0 : Internal error, others : Catalogue already mapped\r\n");
      out.write("\t\t\t\t\tif (data == \"-1\") {\r\n");
      out.write("\t\t\t\t\t\t$(this).find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion1\").html(\"Internal server error\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t//For second OpsCode\r\n");
      out.write("\t\t$(\".secondOpscodeEdit\").blur(function() {\r\n");
      out.write("\t\t\tif ($.trim($(this).val()).length) {\r\n");
      out.write("\t\t\t\tvar postId = $(this).attr(\"id\").substring(17);\r\n");
      out.write("\t\t\t\tvar psValue2 = $.trim($(this).val());\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"../administration/decisionsupport/checkmapping\",//servlet URL that gets first option as parameter and returns JSON of to-be-populated options\r\n");
      ...
      out.write("\t\t\t\t\t// -1 : PSCode doesn't exist, 0 : Catalogue not mapped yet, others : Catalogue already mapped\r\n");
      out.write("\t\t\t\t\tif (data == \"-1\" || data == \"0\") {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForSecondOpscodeEdit\"+postId).find('option:selected').removeAttr(\"selected\");\r\n");
      out.write("\t\t\t\t\t\t// ask user to set catalogue\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Select a Catalogue\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#aa0000\");\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\"#catalogueForSecondOpscodeEdit\"+postId).val(data);\r\n");
      out.write("\t\t\t\t\t\t$(\".mappingSuggestion2\").html(\"Catalogue found\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.css(\"color\",\"#00aa00\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t$(\".catalogue22\").show();\r\n");
      out.write("\t\t\t} else\r\n");
      out.write("\t\t\t$(\".catalogue22\").hide();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\".catalogueForSecondOpscodeEdit\").change(function() {\r\n");
      out.write("\t\t\tvar postId = $(this).attr(\"id\").substring(29);\r\n");
      out.write("\t\t\tif (parseInt($(this).val()) > 0) {\r\n");
      out.write("\t\t\t\t$(\".mappingSuggestion2\").html(\"Updating Catalogue...\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.css(\"color\", \"#00aa00\");\r\n");
      out.write("\t\t\t\tvar clValue2 = $(this).val();\r\n");
      out.write("\t\t\t\tvar psValue2 = $.trim($(\"#secondOpscodeEdit\"+postId).val());\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"../administration/decisionsupport/updatemapping\",//servlet URL that gets first option as parameter and returns JSON of to-be-populated options\r\n");
      out.write("\t\t\t\t\tdata : \"psValue=\" + psValue2 + \"&clValue=\" + clValue2,\r\n");
      out.write("\t\t\t\t\ttype : \"POST\",//request type, can be GET\r\n");
	...
	DateFormat pickerFormatter = new SimpleDateFormat("dd-MM-yyyy");
      ...
      out.write("\t\t\t\t<td style=\"width: 950px;\"><legend class=\"legendFont\">Decision\r\n");
      out.write("\t\t\t\t\t\tSupport</legend></td>\r\n");
      out.write("\t\t\t\t<td class=\"buttonRight\">\r\n");
      out.write("\t\t\t\t\t<!-- Button to trigger modal for adding a new operation --> <a\r\n");
      out.write("\t\t\t\t\thref=\"#myAddURL\" class=\"btn btn-primary\" role=\"button\"\r\n");
      out.write("\t\t\t\t\tdata-toggle=\"modal\"> Add Operation </a> <!-- URL for adding the operation; the new values will be available in controller using parameters -->\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<div id=\"myAddURL\" class=\"modal hide fade\" tabindex=\"-1\"\r\n");
      out.write("\t\t\t\t\t\t\trole=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a class=\"close\" data-dismiss=\"modal\">×</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<h3 id=\"myModalLabel\" style=\"text-align: left\">Add\r\n");
      out.write("\t\t\t\t\t\t\t\t\tOperation</h3>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"modal-body\" style=\"text-align: left;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<br />\r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"vertical-align: baseline;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span id=\"editSpan\">OPSC01:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tid=\"firstOpscode\" name=\"opsc1Add\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Type code...\" required />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue1\" id=\"editSpan\">Catalogue:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"catalogue1\" style=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> ");
      if (_jspx_meth_c_005fif_005f9(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue1\" id=\"editSpan\">Difficulty:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"catalogue1\"> <span class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"controls\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"difficultyForFirstOpscode\" value=\"1\" checked>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tNormal &nbsp;&nbsp; <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"difficultyForFirstOpscode\" value=\"2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tDifficult\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <br />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span id=\"editSpan\">OPSC02:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tid=\"secondOpscode\" name=\"opsc2Add\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Type code...\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue2\" id=\"editSpan\">Catalogue</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"catalogue2\" style=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue2\" id=\"editSpan\">Difficulty:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"catalogue2\"> <span class=\"control-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"controls\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"difficultyForSecondOpscode\" value=\"1\" checked>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tNormal &nbsp;&nbsp; <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"difficultyForSecondOpscode\" value=\"2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tDifficult\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <br />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span id=\"editSpan\">Operation date:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"input-append date datepicker\" id=\"dpOperationDate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-date='");
      out.print(pickerFormatter.format(new Date()));
      out.write("'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-date-format=\"dd-mm-yyyy\"> <input name=\"opDateAdd\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"span2\" size=\"16\" type=\"text\" readonly=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvalue='");
      out.print(pickerFormatter.format(new Date()));
      out.write("'> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"add-on\"><i class=\"icon-th\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <br> <br> <span id=\"editSpan\">Op1:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span id=\"editSpan\">Op2:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span> <span id=\"editSpan\">Ass1:</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\"> ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span><span id=\"editSpan\">Allow Replace? :</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"deletable\" value=\"0\" checked>No &nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"deletable\" value=\"1\">Yes\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t<li class=\"active\"><a href=\"#dSupportResidents\"\r\n");
      out.write("\t\t\t\t\tdata-toggle=\"tab\">List</a></li>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<table id=\"zebraTable\" class=\"table table-hover\"\r\n");
      out.write("\t\t\t\t\t\tstyle=\"width: 1100px;\">\r\n");
      out.write("\t\t\t\t\t\t<thead>\r\n");
      ...
      // /WEB-INF/jsp/admin/DecisionSupport.jsp(580,7) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/admin/DecisionSupport.jsp(580,7) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t\t\t\t\t\t\t\t\t\trole=\"button\" data-toggle=\"modal\"> More > </a> <!-- Modal for editing the current operation -->\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div id=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${myResidentListURL}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("\" class=\"modal hide fade\"\r\n");
            ...
            // /WEB-INF/jsp/admin/DecisionSupport.jsp(628,13) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            // /WEB-INF/jsp/admin/DecisionSupport.jsp(628,13) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_c_005fforEach_005f8 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
															...
															Object attribute = pageContext.getSession().getAttribute(
																			"tempResidentStatus");
																	...
																	pageContext.setAttribute("residentStatus",
																			Double.parseDouble(formatter.format(status)));
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-footer\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-primary\" data-dismiss=\"modal\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\taria-hidden=\"true\">OK</a>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f8(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(25,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f9(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(26,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(355,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setVar("headerGoSchedule");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(355,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setValue(new String("../schedule/view"));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(355,2) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(356,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setVar("headerViewAdministration");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(356,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setValue(new String("../administration/home"));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(356,2) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(358,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f2.setVar("headerModule");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(358,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fremove_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(360,2) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fremove_005f0.setVar("headerViewSchedule");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(360,2) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fremove_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(361,2) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fremove_005f1.setVar("headerGoAdministration");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(361,2) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f12(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(374,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f12.setVar("addUrl");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(374,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f9(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(398,57) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f9 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"catalogueForFirstOpscode\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"catalogueForFirstOpscode\">\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f9, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(403,14) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(403,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(406,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f10(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(432,57) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f10 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"catalogueForSecondOpscode\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"catalogueForSecondOpscode\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"-1\">&nbsp;</option>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f10, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(437,14) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(437,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(440,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f11(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(468,57) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f11 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"sub-controls\"> <input type=\"checkbox\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"opscToCountForOp1\" value=\"OPSC01\" checked> OPSC01 <input\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"checkbox\" name=\"opscToCountForOp1\" value=\"OPSC02\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tOPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f11, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(471,14) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(471,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f3)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(473,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f12(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(487,57) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f12 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"sub-controls\"> <input type=\"checkbox\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"opscToCountForOp2\" value=\"OPSC01\"> OPSC01 <input\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"checkbox\" name=\"opscToCountForOp2\" value=\"OPSC02\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tOPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f12, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(490,14) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(490,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f4)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(492,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f13(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(506,57) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f13 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"sub-controls\"> <input type=\"checkbox\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"opscToCountForAss1\" value=\"OPSC01\"> OPSC01 <input\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"checkbox\" name=\"opscToCountForAss1\" value=\"OPSC02\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tOPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f13, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(509,14) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(509,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f5, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f5)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(511,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f3(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(551,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f3.setVar("count");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(551,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(581,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f4.setVar("catalogNr");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(581,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(583,34) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f5.setVar("count");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(583,34) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(584,35) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(585,35) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(587,13) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(587,13) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f7.setVar("items");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(587,13) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f7.setBegin(0);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(587,13) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(589,11) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f6.setVar("residentStatus");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(589,11) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(591,11) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"color: #FF5640;\"> <b>");
  ...
  private boolean _jspx_meth_c_005fout_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f14, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(592,46) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f15(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(596,11) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f15, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(597,19) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f16(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f7, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f7)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(600,11) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f16 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"tooltip-test\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdata-original-title=\"Training duration is not accurate. Decision support cannot be provided for this resident. Please change the duration or deactivate the resident.\">\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(610,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f7.setVar("myResidentListURL");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(610,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f6, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f6)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(624,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(629,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f8.setVar("tempResidentStatus");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(629,14) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f8.setScope("session");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(629,14) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f17(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(644,15) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f17, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(645,61) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f18(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f17, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(646,47) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f18 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"tooltip-test\" data-placement=\"right\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-original-title=\"Training duration is not accurate. Decision support cannot be provided for this resident. Please change the duration or deactivate the resident.\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"badge badge-important\">!</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f19(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(655,15) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f19, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(656,37) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f20(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f19, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(657,47) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(667,27) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(668,40) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f15(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f8, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f8)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(670,27) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f9(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(696,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f9.setVar("count");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(696,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f9(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(717,7) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(717,7) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f9 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\" class=\"editButon\"  id=\"editButon");
          ...
          out.write("\" style=\"font-size: 12px;\" role=\"button\" data-toggle=\"modal\"> View </a> <!-- Generate the URL with the dSuppOpId -->\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005furl_005f13(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t<form method=\"POST\" class=\"editOperationForm\" id=\"editOperationForm");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("\" action=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-header\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"close\" data-dismiss=\"modal\">×</a>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<h3 id=\"myModalLabel\">View operation</h3>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-body\" style=\"text-align: left;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<br />\r\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"firstOpscodeEdit\" id=\"firstOpscodeEdit");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("\" name=\"opsc1Add\" type=\"text\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Type code...\" value=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue11\" id=\"editSpan\">Catalogue:</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"catalogue11\" style=\"vertical-align: baseline;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"control-group\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"controls\"> ");
          if (_jspx_meth_c_005fif_005f21(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue11\" id=\"editSpan\">Difficulty:</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"catalogue11\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"difficultyForFirstOpscode\" value=\"1\" ");
          if (_jspx_meth_c_005fif_005f22(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("> Normal &nbsp;&nbsp; \r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"difficultyForFirstOpscode\" value=\"2\" ");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"secondOpscodeEdit\" id=\"secondOpscodeEdit");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("\" name=\"opsc2Add\" type=\"text\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Type code...\" value=\"");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue22\" id=\"editSpan\">Catalogue</span> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"catalogue22\" style=\"vertical-align: baseline;\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"control-group\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"controls\"> ");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span class=\"catalogue22\" id=\"editSpan\">Difficulty:</span>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"catalogue22\"> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"control-group\"> <span class=\"controls\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"difficultyForSecondOpscode\" value=\"1\" ");
          if (_jspx_meth_c_005fif_005f25(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("> Normal &nbsp;&nbsp; \r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"difficultyForSecondOpscode\" value=\"2\" ");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <br />\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span> <span id=\"editSpan\">Operation date:</span> <span\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"vertical-align: baseline;\"> \r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"input-append date datepicker\" id=\"dpOperationDate\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-date='");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${formatedDte}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("'\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-date-format=\"dd-mm-yyyy\"> <input\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"opDateAdd\" class=\"span2\" size=\"16\" type=\"text\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treadonly=\"\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue='");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${formatedDte}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("'>\r\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\taria-hidden=\"true\">Cancel</a> \r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- input type=\"submit\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"Save\" class=\"btn btn-primary\" / -->\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t</form>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
          ...
          out.write("\" style=\"font-size: 12px;\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\trole=\"button\" data-toggle=\"modal\"> Delete </a> <!-- Generate the URL with the dSuppOpId -->\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fif_005f39(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("\r\n");
          out.write("\r\n");
          ...
          if (_jspx_meth_fmt_005fformatDate_005f2(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("</strong> <br>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"deleteSpan\">Op1 </span><strong>");
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fif_005f41(_jspx_th_c_005fforEach_005f9, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
            return true;
          out.write("\r\n");
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"white-space: pre;\"> ?</span> <br />\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-footer\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn\" data-dismiss=\"modal\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\taria-hidden=\"true\">Cancel</a> <input type=\"submit\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"Delete\" class=\"btn btn-primary\" />\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t</form>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(718,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f10.setVar("operationNr");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(718,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(720,13) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f11.setVar("count");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(720,13) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f16(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(720,56) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(723,13) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f0.setPattern("dd.MM.yyyy");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(723,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f17(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(725,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f18(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(726,33) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f19(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(728,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f20(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(729,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f21(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(730,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f22(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(731,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(735,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f12.setVar("myEditOperationURL");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(735,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(737,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f13.setVar("editOperationURL");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(737,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f21(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(763,34) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f21.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filteredOpCatalogues != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f21 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"catalogueForFirstOpscodeEdit\" \r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"catalogueForFirstOpscodeEdit");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"catalogueForFirstOpscode\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"-1\">&nbsp;</option>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f21, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(769,19) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f10.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filteredOpCatalogues}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(769,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f10.setVar("opCatalogue");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f10 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fout_005f23(_jspx_th_c_005fforEach_005f10, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f10))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f23(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f10, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f10)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f23.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f10);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(772,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f23.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${opCatalogue.name}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f22(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    _jspx_th_c_005fif_005f22.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f9);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(783,80) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f22.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.OPSC01Difficulty == 1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f23(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(784,80) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f23.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.OPSC01Difficulty == 2}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f24(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(797,34) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f24.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filteredOpCatalogues != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f24 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"catalogueForSecondOpscodeEdit\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t \tid=\"catalogueForSecondOpscodeEdit");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\"\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"catalogueForSecondOpscode\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"-1\">&nbsp;</option>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f24, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(803,19) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f11.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filteredOpCatalogues}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(803,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f11.setVar("opCatalogue");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f11 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fout_005f24(_jspx_th_c_005fforEach_005f11, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f11))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f24(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f11, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f11)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f24.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f11);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(806,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f24.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${opCatalogue.name}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f25(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(817,81) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f25.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.OPSC02Difficulty == 1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f26(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(818,81) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f26.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.OPSC02Difficulty == 2}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:formatDate
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(823,15) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(823,15) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f1.setPattern("dd-MM-yyyy");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(823,15) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f1.setVar("formatedDte");
  ...
  private boolean _jspx_meth_c_005fif_005f27(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(836,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f27 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForOp1\" ");
        if (_jspx_meth_c_005fif_005f29(_jspx_th_c_005fif_005f27, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC01\"> OPSC01 \r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForOp1\" ");
        if (_jspx_meth_c_005fif_005f30(_jspx_th_c_005fif_005f27, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC02\"> OPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f27, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(838,19) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(838,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f12 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fout_005f25(_jspx_th_c_005fforEach_005f12, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f12))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f28(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f12, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f12)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(839,48) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f28.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nickname == operation.op1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f25(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f12, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f12)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f25.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f12);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(840,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f29(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f27, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(845,67) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f29.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.OP1Credit, 'OPSC01')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f30(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f27, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(846,67) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f30.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.OP1Credit, 'OPSC02')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f31(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(854,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f31.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nicknames != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f31 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select name=\"op2Add\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
        if (_jspx_meth_c_005fforEach_005f13(_jspx_th_c_005fif_005f31, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"sub-controls\"> \r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForOp2\" ");
        if (_jspx_meth_c_005fif_005f33(_jspx_th_c_005fif_005f31, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC01\"> OPSC01 \r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForOp2\" ");
        if (_jspx_meth_c_005fif_005f34(_jspx_th_c_005fif_005f31, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC02\"> OPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f31, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:forEach
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(856,19) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f13.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nicknames}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(856,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f13.setVar("nickname");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f13 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fout_005f26(_jspx_th_c_005fforEach_005f13, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f13))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f32(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f13, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f13)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(857,48) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f32.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nickname == operation.op2}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f26(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f13, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f13)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f26.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f13);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(858,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f33(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f31, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(863,67) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f33.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.OP2Credit, 'OPSC01')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f34(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f31, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(864,67) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f34.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.OP2Credit, 'OPSC02')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f35(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(872,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f35.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nicknames != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f35 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select name=\"ass1Add\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
        if (_jspx_meth_c_005fforEach_005f14(_jspx_th_c_005fif_005f35, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"sub-controls\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForAss1\" ");
        if (_jspx_meth_c_005fif_005f37(_jspx_th_c_005fif_005f35, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC01\"> OPSC01 \r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"opscToCountForAss1\" ");
        if (_jspx_meth_c_005fif_005f38(_jspx_th_c_005fif_005f35, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write(" value=\"OPSC02\"> OPSC02\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f35, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:forEach
    ...
    _jspx_th_c_005fforEach_005f14.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f35);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(874,19) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f14.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nicknames}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(874,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f14.setVar("nickname");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f14 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
          if (_jspx_meth_c_005fout_005f27(_jspx_th_c_005fforEach_005f14, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f14))
            return true;
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f36(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f14, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f14)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(875,48) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f36.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nickname == operation.ass1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f27(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f14, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f14)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f27.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f14);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(876,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f37(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f35, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(881,68) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f37.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.ass1Credit, 'OPSC01')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f38(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f35, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(882,68) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f38.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:contains(operation.ass1Credit, 'OPSC02')}", java.lang.Boolean.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fset_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(902,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f13.setVar("deleteOperationURL");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(902,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f13.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("delOperation${count}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005furl_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(905,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f14.setVar("deleteUrl");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(905,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f28(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(923,62) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f28.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.opsc1}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f39(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    _jspx_th_c_005fif_005f39.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f9);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(926,15) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f39.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.opsc2 != ''}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f39 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"deleteSpan\">OPSC02 </span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<strong>");
        if (_jspx_meth_c_005fout_005f29(_jspx_th_c_005fif_005f39, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write("</strong>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f29(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f39, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f29.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f39);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(929,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f29.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.opsc2}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(932,67) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f2.setPattern("dd.MM.yyyy");
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(932,67) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f30(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(934,59) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f30.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.op1}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f40(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(937,15) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f40.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.op2 != ''}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f40 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"deleteSpan\">Op2 </span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<strong>");
        if (_jspx_meth_c_005fout_005f31(_jspx_th_c_005fif_005f40, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write("</strong>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f31(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f40, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f31.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f40);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(940,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f31.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.op2}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f41(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f9, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    _jspx_th_c_005fif_005f41.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fforEach_005f9);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(943,15) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f41.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.ass1 != ''}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    ...
    if (_jspx_eval_c_005fif_005f41 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"deleteSpan\">Ass1 </span>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<strong>");
        if (_jspx_meth_c_005fout_005f32(_jspx_th_c_005fif_005f41, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f9))
          return true;
        out.write("</strong>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f32(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f41, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f9)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    _jspx_th_c_005fout_005f32.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f41);
    // /WEB-INF/jsp/admin/DecisionSupport.jsp(946,24) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f32.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${operation.ass1}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
