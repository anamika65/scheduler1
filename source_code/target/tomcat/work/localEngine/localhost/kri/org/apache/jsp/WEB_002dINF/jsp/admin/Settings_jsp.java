  ...
  private boolean _jspx_meth_sec_005fauthorize_005f2(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_sec_005fauthorize_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write(" \t\t\t\t\t\t Configure Training Duration parameters that are common across all specializations.\r\n");
        out.write("\t\t\t\t\t\t\t This configuration will be applied to all residents when generating a new monthly schedule.\r\n");
        out.write("\t\t\t\t\t</div>\r\n");
